...
import { IUser } from '../../interfaces/Medic';
...
function RegisterComplete() {
  ...
  //xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
    function confirmUserAcess(callback: React.Dispatch<React.SetStateAction<IUser[]>>) {
        const collectionReference = collection(db, 'users');
        const response = query(collectionReference, where('user.uid', '==', uid));
  ...
  const [medic, setMedic] = useState<IUser[]>([]);
   useEffect(() => {
      confirmUserAcess(setMedic)
   }, [])
